            ...
            public void actionPerformed(ActionEvent e) {
                if(e.getSource()==addButton){
                    ...
                    switch((Integer) requestSent){
                        case 0:JOptionPane.showMessageDialog(null,"Sent friend request to "+userToAdd+".","Success",JOptionPane.INFORMATION_MESSAGE);
                        case 1:JOptionPane.showMessageDialog(null,"Error: You are already friends with this user.","Error",JOptionPane.ERROR_MESSAGE);
                        case 2:JOptionPane.showMessageDialog(null,"Error: You have already sent this user a friend request.","Error",JOptionPane.ERROR_MESSAGE);
                        case 3:JOptionPane.showMessageDialog(null,"Error: "+userToAdd+" has already sent you a friend request (accept below).","Error",JOptionPane.ERROR_MESSAGE);
                        case 4:JOptionPane.showMessageDialog(null,"Error: User "+userToAdd+" could not be found.","Error",JOptionPane.ERROR_MESSAGE);
                    }
                }}});
